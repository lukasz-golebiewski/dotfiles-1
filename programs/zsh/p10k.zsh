# ===========================================================================
# NOTE: on NixOS, ~/.config/zsh points to the store, which is not writable.
# Therefore, `p10k configure` fails with `~/.config/zsh` is not writable. The
# ugly workaround I used to generate this config is to open a new shell, then:
#
#
# mkdir p10k_tmp
# cd p10k_tmp
...
# export HOME=$(pwd)
# zsh
# source ${OLD_ZDOTDIR}/plugins/powerlevel10k/prompt_powerlevel10k_setup
# ===========================================================================

# Generated by Powerlevel10k configuration wizard on 2020-01-19 at 14:25 CET.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh.
# Wizard options: nerdfont-complete + powerline, small icons, lean, 2 lines,
# disconnected, left frame, light, sparse, few icons, concise, transient_prompt,
